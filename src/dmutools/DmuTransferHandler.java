 ...
 * @author mats
 */
public class DmuTransferHandler extends TransferHandler {

    public void setDmuProgram(DmuProgram dmuProgram) {
        this.dmuProgram = dmuProgram;
    }
    
    DmuProgram dmuProgram;
    ...
    public boolean importData(TransferHandler.TransferSupport info) {
        ...
        if ( fileList != null ) {
            if (fileList.size() > 0 ) dmuProgram.readFile(  fileList.get(0)  );
        }
        return true;
    }
